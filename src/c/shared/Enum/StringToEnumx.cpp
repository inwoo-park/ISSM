...
int  StringToEnumx(const char* name,bool notfounderror){
   ...
   if(stage==1){
	      ...
	      else if (strcmp(name,"BasalforcingsIsmip7AverageTheta")==0) return BasalforcingsIsmip7AverageThetaEnum;
   ...
   if(stage==3){
	      if (strcmp(name,"FrontalForcingsSdmalagcoefs")==0) return FrontalForcingsSdmalagcoefsEnum;
   ...
   if(stage==5){
	      if (strcmp(name,"SolidearthSettingsCrossSectionShape")==0) return SolidearthSettingsCrossSectionShapeEnum;
   ...
   if(stage==7){
	      ...
	      else if (strcmp(name,"BasalforcingsIsmip7Theta")==0) return BasalforcingsIsmip7ThetaEnum;
