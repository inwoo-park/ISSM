/*! \file BasalforcingsLaddieHeatAnalysis.h 
 *  \brief: header file for generic external result object
 */

#ifndef _BasalforcingsLaddieHeatAnalysis_
#define _BasalforcingsLaddieHeatAnalysis_

/*Headers*/
#include "./Analysis.h"

class BasalforcingsLaddieHeatAnalysis: public Analysis{
